...
protected:
  ...
  CodeBlob* _pre_barrier_c1_runtime_code_blob_with_patch_fix;
...
public:
  ...
  MMTkBarrierSetC1()
    : _pre_barrier_c1_runtime_code_blob(NULL),
      _pre_barrier_c1_runtime_code_blob_with_patch_fix(NULL),
  ...
  CodeBlob* pre_barrier_c1_runtime_code_blob_with_patch_fix() { return _pre_barrier_c1_runtime_code_blob_with_patch_fix; }
