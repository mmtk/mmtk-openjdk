...
void MMTkObjectBarrierRuntime::record_modified_node(oop src) {
  record_modified_node_slow((void*) src);
}

#define __ masm->

void MMTkObjectBarrierAssembler::oop_store_at(MacroAssembler* masm, DecoratorSet decorators, BasicType type, Address dst, Register val, Register tmp1, Register tmp2) {
...
void MMTkObjectBarrierAssembler::record_modified_node(MacroAssembler* masm, Register obj) {
  __ pusha();
...
void MMTkObjectBarrierC1::record_modified_node(LIRAccess& access, LIR_Opr src, LIR_Opr slot, LIR_Opr new_val) {
...
void MMTkObjectBarrierC2::record_modified_node(GraphKit* kit, Node* node) const {
