...
const TypeFunc* write_barrier_slow_entry_Type() {
  ...
  fields[TypeFunc::Parms+1] = TypeOopPtr::NOTNULL; // oop src
...
void MMTkBarrierSetC2::write_barrier(GraphKit* kit,
  ...
  __ make_leaf_call(tf, CAST_FROM_FN_PTR(address, MMTkBarrierRuntime::write_barrier_slow), "write_barrier_slow", tls, obj, val);
