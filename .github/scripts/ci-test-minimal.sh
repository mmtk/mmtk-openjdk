...
MMTK_PLAN=Lisp2 runbms_dacapo2006_with_heap_multiplier fop 4
MMTK_PLAN=OVC runbms_dacapo2006_with_heap_multiplier fop 4
...
MMTK_PLAN=LXR MMTK_NO_REFERENCE_TYPES=true runbms_dacapo2006_with_heap_multiplier fop 4
